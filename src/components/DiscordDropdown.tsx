...
export function DiscordDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-gradient-to-b from-[#2B2D31] to-[#1E1F22] rounded-lg shadow-xl py-2 z-50 border border-[#5865F2]/20 backdrop-blur-sm">
          <button
